...
export const mockSignals: Signal[] = [
  ...
  {
    id: 'sq1',
    title: "L'uniforme scolaire ameliorera-t-il le climat dans les ecoles francaises ?",
    description: "Egalite vestimentaire, sentiment d'appartenance ou atteinte a la liberte ? Un debat qui touche toutes les familles.",
  ...
  {
    id: 'sq2',
    title: 'Faut-il verser 100 000 € d\'un coup plutot que le RSA mensuel ?',
    description: 'Capital unique pour sortir de la precarite vs. filet de securite mensuel. Un choix de societe majeur.',
  ...
  {
    id: 'sq3',
    title: "L'uniforme professionnel generalise reduirait-il les inegalites en entreprise ?",
    description: 'Pression vestimentaire, marques de luxe au bureau. L\'uniforme pro, solution ou regression ?',
  ...
  {
    id: 'sq4',
    title: 'Le Service National Universel devrait-il etre obligatoire a 18 ans ?',
    description: 'Cohesion, mixite, engagement citoyen. Mais a quel prix pour la liberte individuelle ?',
    category: 'society', region: 'france', status: 'active',
  ...
  {
    id: 'sq5',
    title: 'La France devrait-elle revenir a la retraite a 60 ans ?',
    description: 'Esperance de vie, equilibre des caisses, dignite des seniors. Le debat qui divise toutes les generations.',
    category: 'work', region: 'france', status: 'active',
  ...
  {
    id: 'sq6',
    title: 'Les aides sociales devraient-elles etre conditionnees a une activite ?',
    description: 'Valorisation par le travail ou stigmatisation des plus fragiles ? Un equilibre delicat.',
    category: 'society', region: 'france', status: 'active',
  ...
  {
    id: 'sq7',
    title: 'Une prime de naissance de 10 000 € reduirait-elle les inegalites ?',
    description: 'Soutien aux familles, relance demographique. Mais a quel cout pour les finances publiques ?',
    category: 'finance', region: 'france', status: 'active',
  ...
  {
    id: 'sq8',
    title: 'La gratuite des transports en commun devrait-elle etre generalisee ?',
    description: 'Ecologie, mobilite, justice sociale. Des villes l\'ont fait. La France entiere devrait-elle suivre ?',
    category: 'society', region: 'france', status: 'active',
  ...
  {
    id: 'sq9',
    title: 'La semaine de 32 heures augmenterait-elle la productivite ?',
    description: 'Bien-etre, concentration, partage du travail. Ou perte de competitivite ? Le debat est lance.',
    category: 'work', region: 'france', status: 'active',
  ...
  {
    id: 'sq10',
    title: 'Un capital de 20 000 € a 18 ans serait-il plus efficace que les bourses ?',
    description: 'Etudes, entreprise, logement : laisser choisir les jeunes plutot que flechir les aides.',
  ...
  },
  {
    ...
    description: 'APL, ALS, ALF : un mille-feuille administratif. La simplification profiterait-elle a tous ?',
  ...
  {
    id: 'sq12',
    title: 'Un conge parental d\'un an pour chaque parent changerait-il la societe ?',
    description: 'Egalite parentale, bien-etre de l\'enfant, modele nordique. La France est-elle prete ?',
    category: 'society', region: 'france', status: 'active',
