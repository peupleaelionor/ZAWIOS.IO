            ...
            <section>
              ...
              <div className="space-y-3 mb-4">
                {[
                  ...
                  { label: 'NO', color: 'var(--text2)', desc: 'Désaccord avec la proposition. Vote engagé négatif.' },
        ...
        >
          <div className="container max-w-xl flex items-center justify-between gap-4 flex-wrap">
            ...
            <Link
              ...
              style={{ background: 'var(--surface)', border: '1px solid var(--border2)', color: 'var(--text)', fontFamily: 'var(--font)' }}
            >
              Nous contacter
            </Link>
          </div>
