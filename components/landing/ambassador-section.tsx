...
const AMBASSADOR_CITIES = [
  { name: 'Kinshasa', country: 'RD Congo', x: 165, y: 100, color: 'var(--teal)', members: '2.4K' },
  { name: 'Paris', country: 'France', x: 153, y: 33, color: 'var(--accent2)', members: '3.1K' },
  { name: 'Lagos', country: 'Nigeria', x: 155, y: 88, color: 'var(--teal)', members: '1.8K' },
  { name: 'Bruxelles', country: 'Belgique', x: 150, y: 30, color: 'var(--accent2)', members: '890' },
  { name: 'Dakar', country: 'Sénégal', x: 130, y: 78, color: 'var(--teal)', members: '1.2K' },
  { name: 'New York', country: 'USA', x: 60, y: 45, color: 'rgba(255,255,255,0.4)', members: '5.2K' },
  { name: 'Abidjan', country: "Côte d'Ivoire", x: 143, y: 88, color: 'var(--teal)', members: '1.1K' },
]
  ...
  return (
    <div className="relative w-full" style={{ maxWidth: '540px' }}>
      ...
      >
        ...
        <path d="M148 60 L172 58 L185 75 L188 105 L175 125 L155 128 L140 110 L135 85 Z" fill="rgba(23,213,207,0.05)" stroke="rgba(23,213,207,0.18)" strokeWidth="0.8" />
