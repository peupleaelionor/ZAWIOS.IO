  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={activeRegion === 'europe' || activeRegion === 'global' ? 'rgba(90,75,255,0.15)' : 'rgba(255,255,255,0.04)'}
        stroke={activeRegion === 'europe' ? 'rgba(90,75,255,0.5)' : 'rgba(255,255,255,0.08)'}
        strokeWidth="0.8"
...
const REGION_TABS = [
  { id: 'global', label: 'Monde', votes: '2M' },
      ...
      <div className="container">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-[var(--text2)]">
            Compare l&apos;opinion par région — Afrique, Europe, USA, Monde.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2">
                    {[
                      { label: 'Monde', value: bd.global, highlight: false },
